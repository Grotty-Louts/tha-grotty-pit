...
const combatReport = function(attacker , defender){
    ...
    console.log(attacker.name + ' deals ' + damageValue + ' damage!')
...
hitOpponent = function(attacker , defender){
    ...
    if(attacker.skill == defender.deftness && hitVariance > 50){
      damageOpponent(attacker , defender)
    }
    else if(attacker.skill > defender.deftness && hitVariance > 20){
      damageOpponent (attacker , defender);
    }
    else if(attacker.skill < defender.deftness && hitVariance > 80){
      damageOpponent (attacker , defender);
    }
    else {console.log(attacker.name + ' misses their strike!')}   
    }
